/*-------------------------------------------------------------------------
 ...
 - 18.10.2018, FKling, Added flags for an instance allowing fine grained control (see: kFlags)
...
const char *LogPropertyReader::GetValue(const char *key, char *dst, int nMax, const char *defValue)
{
